...
export const unitsMentah: unknown[] = [
  {
    ...
    deskripsi_singkat:
      "Taman asuh usia dini berbasis Al-Qur'an untuk anak 4–6 tahun, kini hadir di sepuluh cabang dengan kurikulum yang sama.",
  ...
  },
  {
    ...
    logo: { src: "/img/logo-mahabbah.png", alt: "Logo Mahabbah — Ma’had Bahasa dan Studi Islam Wadi Mubarak", width: 1192, height: 1290 },
    warna_aksen: "#0369a1",
    jenjang: "non-formal",
    gender: "putra",
    model_belajar: "boarding",
