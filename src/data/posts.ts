...
const daftar: PostInput[] = [
  {
    ...
    ringkasan:
      "Sebanyak 47 santri MA Tahfizh Putra dan MA MBS Putri menuntaskan hafalan 30 juz dan menjalani tasmi' terbuka di hadapan wali santri.",
    tanggal: "2026-07-12",
    category: "prestasi",
    unit_utama: "ma-tahfizh-putra",
  ...
  },
  {
    ...
    ringkasan:
      "Pendaftaran santri baru untuk MIT, MTs, dan MA Tahfizh dibuka mulai 1 Oktober dengan kuota terbatas per rombongan belajar.",
    tanggal: "2026-07-08",
    category: "pengumuman",
    unit_utama: "mit-saqu",
    ...
    tampilkan_di_induk: true,
    konten: paragraf(
      "Panitia Penerimaan Peserta Didik Baru Islamic Center Wadi Mubarak mengumumkan pembukaan gelombang pertama tahun ajaran 2026/2027. Pendaftaran dibuka untuk jenjang MI, MTs, dan MA di kampus Bogor.",
  ...
  },
  {
    ...
    ringkasan:
      "Yayasan menandatangani nota kesepahaman jalur rekomendasi beasiswa bagi lulusan MA Tahfizh Putra dan MA Mahabbah Boarding School.",
    tanggal: "2026-06-24",
    category: "kerja-sama",
    unit_utama: "ma-tahfizh-putra",
    unit: ["ma-tahfizh-putra", "ma-mbs-putri"],
  ...
  {
    slug: "pekan-proyek-santri-mit-tema-air",
    judul: "Pekan Proyek MIT: Santri Meneliti Sumber Air Kampus",
    ringkasan:
  ...
  },
  {
    ...
    tanggal: "2026-05-28",
    category: "prestasi",
    unit_utama: "mts-tahfizh-putra",
    unit: ["mts-tahfizh-putra", "ma-tahfizh-putra"],
    lokasi: "bogor",
  ...
  },
  {
    ...
    tanggal: "2026-05-14",
    category: "berita",
    unit_utama: "mts-mbs-putri",
    unit: ["mts-mbs-putri", "ma-mbs-putri"],
    lokasi: "bogor",
    topik: ["pembangunan"],
    gambar: 8,
  ...
  {
    slug: "kaderisasi-muhaffizh-angkatan-baru-dibuka",
    judul: "Kaderisasi Muhaffizh Angkatan Baru Dibuka dengan Beasiswa Penuh",
    ringkasan:
      "PKM Wadi Mubarak menerima 40 calon pengampu tahfizh berhafalan minimal 15 juz; seluruh biaya program dan asrama ditanggung yayasan.",
    tanggal: "2026-05-06",
    category: "pengumuman",
    unit_utama: "pkm-wadi-mubarak",
    lokasi: "bogor",
    topik: ["tahfizh", "kaderisasi"],
    gambar: 9,
